...
#include "com_bearya_actionlib_canjni_Canjni.h"
...
JNIEXPORT jint JNICALL Java_com_bearya_actionlib_canjni_Canjni_OpenRf24l01(JNIEnv *env, jclass thiz ) {
...
JNIEXPORT jint JNICALL Java_com_bearya_actionlib_canjni_Canjni_CloseRf24l01(JNIEnv *env, jclass thiz ) {
...
JNIEXPORT jint JNICALL Java_com_bearya_actionlib_canjni_Canjni_SendRfData(JNIEnv *env, jobject thiz,jbyteArray Txbuf ,jint length) {
...
JNIEXPORT jint JNICALL Java_com_bearya_actionlib_canjni_Canjni_ReceiveRfData(JNIEnv *env, jclass thiz ,jbyteArray Rxbuf ) {
    int ret=0;
//================================================
    if( RX_TX_Flag)
         return 0;
...
JNIEXPORT jint JNICALL Java_com_bearya_actionlib_canjni_Canjni_open_1can(JNIEnv *env, jclass thiz,
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_com_bearya_actionlib_canjni_Canjni_close_1can(JNIEnv *env, jclass thiz) {
 ...
 * Signature: ([BI)I
 */
JNIEXPORT jint JNICALL Java_com_bearya_actionlib_canjni_Canjni_read_1can(JNIEnv *env, jclass thiz,
 ...
 * Signature: ([BI)I
 */
JNIEXPORT jint JNICALL Java_com_bearya_actionlib_canjni_Canjni_write_1can(JNIEnv *env, jclass thiz,
                                                                        jbyteArray buffer, jint length,
                                                                        jint frame_type) {
